...
EventManager.lua
Retail event dispatch, quest-state callbacks, and frame coordination
...
--------------------------------------------------
	...
	function RQE.handleVehicleActionBar()
		...
		RQE._vehicleActionBarTimer = C_Timer.NewTimer(0.4, function()
			...
			-- Return whether a condition checks for either a player buff or debuff.
...
-- Return whether a step contains a direct or grouped buff/debuff condition.
...
--------------------------------------------------
	...
	-------------------------------------------------------
	-- #6b. Retail Objective Tracker Visibility Hook
	-------------------------------------------------------
