...
RQEFrame.lua
TBC quest helper frame construction, interaction, persistence, and focused-step presentation
...
--------------------------------------------------
	...
	-------------------------------------------------------
	-- #1b. Lua Compatibility & Frame Flags
	-------------------------------------------------------
...
--------------------------------------------------
	...
	-- TBC's GetQuestLogTimeLeft reads the selected quest rather than taking a
	...
	-------------------------------------------------------
	-- #5g. Direction, Availability & Legacy Timer Status
	-------------------------------------------------------
...
-- UpdateButtonVisibility was used only by the removed RQEFrame +/- controls.
	...
	-- Read the current Separate Focus step text from any supported text-widget representation.
...
--------------------------------------------------
	...
	-- Evaluate the displayed quest step and advance its stored step and objective indexes when complete.
...
--------------------------------------------------
	...
	-- Resolve tooltip text and coordinates for the active coordinate-block button.
	...
	-- Enforce the configured visibility state of the Quest Helper and auxiliary quest frames.
