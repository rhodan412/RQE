...
function RQE.AddToDebugLog(message)
	...
	local logEntry
	local playerMapID = RQE.API and RQE.API.GetBestMapForUnit
	...
	local isInScenario = RQE.API and RQE.API.IsInScenario and RQE.API.IsInScenario() or false
...
closeButton:SetScript("OnClick", function()
	...
	-- Close directly: this button belongs to the log frame and should not depend
	-- on the minimap/LDB toggle path being available.
	logFrame:Hide()
end)
