...
function RQE:UpdateQuestFrameSize()
	...
	local questFrameWidth = self.db.profile.QuestFramePosition.frameWidth or 350
...
function RQE:MaximizeQuestFrame()
	local defaultWidth = RQE.db.profile.QuestFrameWidth or 350  -- Default tracker width
...
function RQE:MinimizeQuestFrame()
	RQE.RQEQuestFrame:SetSize(350, (RQE.UI and RQE.UI:IsEnabled()) and 48 or 30)
